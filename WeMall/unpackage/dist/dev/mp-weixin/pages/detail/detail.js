...
/***/ 303:
/*!*******************************************************************************!*\
  !*** D:/idea0/IdeaProjects/WeMall/main.js?{"page":"pages%2Fdetail%2Fdetail"} ***!
  \*******************************************************************************/
...
var _detail = _interopRequireDefault(__webpack_require__(/*! ./pages/detail/detail.vue */ 304));
// @ts-ignore
...
/***/ 304:
/*!************************************************************!*\
  !*** D:/idea0/IdeaProjects/WeMall/pages/detail/detail.vue ***!
  \************************************************************/
/*! no static exports found */
...
/* harmony import */ var _detail_vue_vue_type_template_id_3e159eb4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.vue?vue&type=template&id=3e159eb4& */ 305);
...
/***/ 305:
/*!*******************************************************************************************!*\
  !*** D:/idea0/IdeaProjects/WeMall/pages/detail/detail.vue?vue&type=template&id=3e159eb4& ***!
  \*******************************************************************************************/
...
/***/ 306:
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--17-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/idea0/IdeaProjects/WeMall/pages/detail/detail.vue?vue&type=template&id=3e159eb4& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 307:
/*!*************************************************************************************!*\
  !*** D:/idea0/IdeaProjects/WeMall/pages/detail/detail.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 308:
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/idea0/IdeaProjects/WeMall/pages/detail/detail.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _interface = _interopRequireDefault(__webpack_require__(/*! @/util/interface.js */ 161));
...
var navigation = function navigation() {
  __webpack_require__.e(/*! require.ensure | components/navigationBar */ "components/navigationBar").then((function () {
    return resolve(__webpack_require__(/*! @/components/navigationBar.vue */ 482));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
var popupComponent = function popupComponent() {
  __webpack_require__.e(/*! require.ensure | components/popupComponent */ "components/popupComponent").then((function () {
    return resolve(__webpack_require__(/*! @/components/popupComponent.vue */ 489));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
var _default = {
  data: function data() {
  ...
  methods: {
    ...
    placeOrder: function placeOrder() {
      var res = this.$Inter.judgement(uni.getStorageSync("username"));
      if (res === 0) {
        return;
      }
    ...
    addCart: function addCart(title) {
      var ob = {};
      var res = this.$Inter.judgement(uni.getStorageSync("username"));
      if (res === 0) {
        return;
      ...
      this.$store.dispatch("setbookCartRec", this.book.title);
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                res = _context.sent;
                _this.flag = res.statusCode;
                if (_this.flag == 200) {
                  _this.image_url = "../../static/collectSelcted.png";
                  _this.imageBool = true;
                } else {
                  _this.image_url = "../../static/collect.png";
                  _this.imageBool = false;
                }
              case 5:
              case "end":
    ...
    chatUser: function chatUser() {
      ...
      var that = this;
      uni.navigateTo({
        url: "../chat/index?username=" + that.user.username
      });
    },
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                res = _context2.sent;
                that.book = res.data;
                _this2.currentImage = res.data.image;
              case 6:
              case "end":
    ...
    insertBook: function insertBook(way) {
      var that = this;
      if (way == 1) {
        that.$JerrySecond({
          url: "/insertcollect",
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                _this3.content = "复制联系方式: " + _this3.user.mobile;
                _this3.mobile = _this3.user.mobile;
                _this3.$store.state.userImage = res.data.image;
              case 8:
              case "end":
    ...
    infoSearch: function infoSearch() {},
    deleteCollect: function deleteCollect(user_id, book_id) {
      var _this4 = this;
    ...
    collectSelect: function collectSelect(book_id, title) {
      var res = this.$Inter.judgement(uni.getStorageSync("username"));
      if (res === 0) {
        return;
      }
...
/***/ 309:
/*!**********************************************************************************************!*\
  !*** D:/idea0/IdeaProjects/WeMall/pages/detail/detail.vue?vue&type=style&index=0&lang=scss& ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 310:
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/idea0/IdeaProjects/WeMall/pages/detail/detail.vue?vue&type=style&index=0&lang=scss& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
